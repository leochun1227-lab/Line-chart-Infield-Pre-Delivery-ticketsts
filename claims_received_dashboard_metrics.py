...
def build_claims_received_monthly_payload(
    ...
    default_start_month = add_months(latest_month, -11)
    if default_start_month < min_month:
        default_start_month = min_month
    series = build_series_for_range(monthly_counts, default_start_month, latest_month)
    ...
    return {
        ...
        "defaultRange": {"mode": "last12", "startMonth": default_start_month, "endMonth": latest_month},
